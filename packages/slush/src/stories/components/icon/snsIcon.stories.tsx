...
import { Icon as IconType } from '../../../components/icon'
import * as SnsIcons from '../../../components/icon/sns'
import { IconProps } from '../../../components/icon/type'

const icons = Object.values(SnsIcons)
...
export const SNS = ({ size, color }: IconProps) => {
    return (
        <div
            style={{
                display: 'grid',
