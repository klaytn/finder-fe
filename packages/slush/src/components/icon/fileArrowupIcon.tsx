...
const FileArrowupIcon = ({ size, color = '#19171C' }: IconProps) => {
    return (
        <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M15.2929 14.2929C15.6834 13.9024 16.3166 13.9024 16.7071 14.2929L20.2071 17.7929C20.5976 18.1834 20.5976 18.8166 20.2071 19.2071C19.8166 19.5976 19.1834 19.5976 18.7929 19.2071L16 16.4142L13.2071 19.2071C12.8166 19.5976 12.1834 19.5976 11.7929 19.2071C11.4024 18.8166 11.4024 18.1834 11.7929 17.7929L15.2929 14.2929Z"
                fill={color}
            />
            <path
                fillRule="evenodd"
