...
const CalendarNormalIcon = ({ size, color = '#19171C' }: IconProps) => {
    return (
        <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M20.4473 15.1056C20.7861 15.275 21.0001 15.6212 21.0001 16V22.5C21.0001 23.0523 20.5523 23.5 20.0001 23.5C19.4478 23.5 19.0001 23.0523 19.0001 22.5V18L18.6001 18.3C18.1582 18.6314 17.5314 18.5418 17.2001 18.1C16.8687 17.6582 16.9582 17.0314 17.4001 16.7L19.4001 15.2C19.7031 14.9727 20.1085 14.9362 20.4473 15.1056Z"
                fill={color}
            />
        </svg>
    )
