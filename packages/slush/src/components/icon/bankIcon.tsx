...
const BankIcon = ({ size, color = '#19171C' }: IconProps) => {
    return (
        <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M15.4759 3.14834C15.7973 2.95055 16.2027 2.95055 16.5241 3.14834L29.5241 11.1483C29.9052 11.3828 30.0841 11.8419 29.9622 12.2723C29.8404 12.7028 29.4474 13 29 13H3.00002C2.55263 13 2.15967 12.7028 2.03782 12.2723C1.91598 11.8419 2.0949 11.3828 2.47593 11.1483L15.4759 3.14834ZM6.53307 11H25.467L16 5.17418L6.53307 11Z"
                fill={color}
            />
            <path
                fillRule="evenodd"
