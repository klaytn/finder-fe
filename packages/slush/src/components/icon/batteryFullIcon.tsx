...
const BatteryFullIcon = ({ size, color = '#19171C' }: IconProps) => {
    return (
        <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M17.8 10C18.3523 10 18.8 10.4477 18.8 11V21C18.8 21.5523 18.3523 22 17.8 22C17.2478 22 16.8 21.5523 16.8 21V11C16.8 10.4477 17.2478 10 17.8 10Z"
                fill={color}
            />
            <path
                fillRule="evenodd"
            ...
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M22.4 10C22.9523 10 23.4 10.4477 23.4 11V21C23.4 21.5523 22.9523 22 22.4 22C21.8477 22 21.4 21.5523 21.4 21V11C21.4 10.4477 21.8477 10 22.4 10Z"
                fill={color}
            />
        </svg>
    )
