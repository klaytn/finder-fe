...
const FilePlusIcon = ({ size, color = '#19171C' }: IconProps) => {
    return (
        <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M16 15C16.5523 15 17 15.4477 17 16V22C17 22.5523 16.5523 23 16 23C15.4477 23 15 22.5523 15 22V16C15 15.4477 15.4477 15 16 15Z"
                fill={color}
            />
        </svg>
    )
