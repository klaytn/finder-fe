...
const SpeakerHighIcon = ({ size, color = '#19171C' }: IconProps) => {
    return (
        <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M24 12C24.5523 12 25 12.4477 25 13V19C25 19.5523 24.5523 20 24 20C23.4477 20 23 19.5523 23 19V13C23 12.4477 23.4477 12 24 12Z"
                fill={color}
            />
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M28 10C28.5523 10 29 10.4477 29 11V21C29 21.5523 28.5523 22 28 22C27.4477 22 27 21.5523 27 21V11C27 10.4477 27.4477 10 28 10Z"
                fill={color}
            />
        </svg>
    )
