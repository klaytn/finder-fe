...
type NftBalanceItemBoxProps = {
    data: NftBalanceVO
}

const NftBalanceItemBox = ({
    data: {
            ...
            <Expander>
                ...
                <ExpanderDescription>
                    <DescriptionContainer>
                        ...
                        <Row marginBottom={0}>
                            <TitleText>{klay(tokenCount)}</TitleText>
...
export default NftBalanceItemBox
